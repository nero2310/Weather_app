...
from Weather_app.json_parser import WeatherParser,CityCodes
...
def country_list():
    ...
    navbar_form = NavbarForm()
    return render_template("list_of_countries_codes.html",codes=codes.get_all(),navbar_form=navbar_form)
