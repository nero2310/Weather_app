...
class CurrentWeather:
    ...
    def __init__(self, api_key: AnyStr, city_name: AnyStr, state_code=None,country=None , allow_http=False,
                 api_link="""api.openweathermap.org/data/2.5/weather?q={0},{1},{2}&appid={3}"""):
